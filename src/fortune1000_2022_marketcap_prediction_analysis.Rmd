...
1. **Summary Statistics**: The summary statistics of the dataset are examined to understand the distribution of the data.

2. **Missing Values**: The presence of missing values in the dataset is checked.

3. **Duplicate Rows**: The presence of duplicate rows in the dataset is checked.

4. **Column Names**: The column names are examined to ensure they are consistent and easy to work with.

5. **Unique Values**: The unique values of the categorical columns are examined to understand the different categories present in the dataset.

6. **Outliers**: The presence of outliers in the numerical columns is checked.

7. **Data Quality**: The overall quality of the dataset is assessed.
