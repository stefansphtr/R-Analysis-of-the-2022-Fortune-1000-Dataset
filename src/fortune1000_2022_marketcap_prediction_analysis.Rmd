...
1. **Unique Values**: The unique values of the categorical columns are examined to understand the different categories present in the dataset.

2. **Outliers**: The presence of outliers in the numerical columns is checked.

3. **Data Quality**: The overall quality of the dataset is assessed.
