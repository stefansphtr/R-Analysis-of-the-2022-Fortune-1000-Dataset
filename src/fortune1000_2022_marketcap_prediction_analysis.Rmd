...
```{r relationship-market-cap-sector, echo=TRUE}
# Use the facet_wrap function to create separate boxplots for each sector
ggplot(data = existing_df) +
  geom_boxplot(mapping = aes(x = sector, y = market_cap), fill = "#15925e", color = "black") +
  labs(
